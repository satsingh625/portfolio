...
export const aboutParagraphs: string[] = [
  ...
  'I am a confident communicator with clients over phone, email and chat, comfortable translating between technical and non-technical audiences. I am open to follow-the-sun shift rotations, weekends and holiday coverage for maintenance windows or major incidents.',
];
