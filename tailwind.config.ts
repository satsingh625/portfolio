...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Semantic tokens map to CSS variables defined in globals.css.
      ...
      backgroundImage: {
        'grid': 'linear-gradient(to right, hsl(var(--border) / 0.6) 1px, transparent 1px), linear-gradient(to bottom, hsl(var(--border) / 0.6) 1px, transparent 1px)',
      },
    },
  },
  plugins: [],
